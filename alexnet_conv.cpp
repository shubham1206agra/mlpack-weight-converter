/**
 * @file alexnet_conv.cpp
 * @author Shubham Agrawal
 *
 * Serializes the AlexNet model.
 *
...
int main()
{
  ...
  FFN<> net;
  net.Add<models::AlexNet>();
  net.InputDimensions() = std::vector<size_t>({224, 224, 3});

  net.Parameters() = ReadXML("./alexnet.xml", runningParams);
  ...
  SerializeObject<FFN<>, cereal::BinaryInputArchive>(net, "alexnet.bin");
}