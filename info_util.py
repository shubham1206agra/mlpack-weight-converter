## Copied from TorchInfo
## Yep, T. (2020). torchinfo [Computer software]. https://github.com/TylerYep/torchinfo
...
from torchinfo.enums import ColumnSettings, Mode, RowSettings, Verbosity
from torchinfo.layer_info import LayerInfo, get_children_layers, prod
